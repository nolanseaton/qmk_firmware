...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = KEYMAP_ARROW( /* LAYER 1 */
    ...
    _______,  KC_VOLU,  KC_VOLD,  KC_MPLY,  _______,  _______,  KC_BSLS,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,  _______,
  ...
  [_L2] = KEYMAP_ARROW( /* LAYER 2 */
    ...
    _______,  KC_F11,   KC_F12,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS,   _______,
