...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
               KC_LALT,        MO(L_LOW),           KC_SPC,         KC_ESC,              MO(L_RAI),TG(L_GAM)
           //|--------+-----------------+-----------------+---------------+-----------------------+--------|
  ), [L_LOW] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
          _______, _______, _______, _______, _______,                                                   _______,
  ...
  //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
          _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F8,   KC_F8,   KC_F9, _______,
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
               _______,          _______,          _______,        _______,                _______, _______
           //|--------+-----------------+-----------------+---------------+-----------------------+--------|
  ), [L_RAI] = LAYOUT(
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
               KC_LOCK,          _______,          KC_RSFT,        KC_LCTL,              TG(L_NUM),TG(L_SPC)
           //|--------+-----------------+-----------------+---------------+-----------------------+--------|
  ), [L_NAV] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
  ...
  //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----|
               _______,          _______,          _______,        _______,                _______,   KORLN
           //|--------+-----------------+-----------------+---------------+-----------------------+--------|
  ), [L_NUM] = LAYOUT(
  //|-----------------------------------------------------------------------------------------------------------|
