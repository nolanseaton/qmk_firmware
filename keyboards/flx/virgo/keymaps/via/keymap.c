...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_CAPS,        HOME_A,  HOME_S,  HOME_D,  HOME_F,  HOME_G,                      KC_H,    HOME_J,  HOME_K,  HOME_L,  HOME_SC, KC_QUOT, KC_ENT,
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS,          KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
