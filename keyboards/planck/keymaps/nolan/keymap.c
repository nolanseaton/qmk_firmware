...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		KC_F1,    KC_F5,    KC_F9,    BL_TOGG,  KC_LSFT,  KC_DEL,   KC_BSPC,    KC_ESC,     KC_7,     KC_8,     KC_9,     KC_F1,
		...
		KC_F4,    KC_F8,    KC_F12,   MO(1),    MO(2),    KC_SPC,   KC_SPC,     KC_LGUI,    KC_0,     KC_ENT,   KC_DOT,   KC_F4),
	...
	KEYMAP(
		...
		KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_SPC,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),
